...
class Sidebar extends Component {
	render(props, state) {
		return <div class={`sidebar ${props.visible ? "visible" : "hiding"} ${props.inverted ? "inverted" : ""}`}>
			...
			{false && props.user.level > 0 && <SidebarLink page="admin" icon="server" label="Admin" currentPage={props.page} openPage={props.openPage} />}
