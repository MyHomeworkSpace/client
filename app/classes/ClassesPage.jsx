		...
		return <div class="classesPage">
            <div class="row columns">
                <div class="col-md-3 classesList">
                    ...
                    <ClassList classes={this.state.classes} onClick={this.selectClass.bind(this)}/>
                    <AddClass openModal={props.openModal}/>
                </div>
                <div class="col-md-9">
                    {this.state.selectedClass == null ? <p class="lead noClassSelected">Select a Class for Details</p> : <ClassDetails classObject={this.state.selectedClass} openModal={props.openModal}/>}
                </div>
            </div>
		</div>;
	}
