MyHomeworkSpace.Pages.settings = {
	...
	onLogin: function () {
		...
		$("#settings_two_factor").click(function () {
			MHSBridge.default.openModal("twoFactor");
		});
	...
	open: function () {
		...
		$("#settings_two_factor").text(MyHomeworkSpace.Me.twoFactorVerified == 1 ? "Disable Two-Factor Authentication" : "Enable Two-Factor Authentication")
